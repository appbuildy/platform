...
void main() {
  ...
  test('fromJson() deserialization', () {
      ...
      "value": {
        "mac": {
          ...
          "value": {
            ...
            "restaurant_url": {
              "column": "restaurant_url",
              "data": "https://images.unsplash.com/photo-1552895638-f7fe08d2f7d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80"
            }
          }
        },
        "bk": {
          ...
          "value": {
            ...
            "restaurant_url": {
              "column": "restaurant_url",
              "data": "https://images.unsplash.com/photo-1528669826296-dbd6f641707d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80"
            }
          }
        },
        "lucky": {
    ...
    final SchemaStringListProperty stringListProp = SchemaStringListProperty.fromJson(targetJson);
