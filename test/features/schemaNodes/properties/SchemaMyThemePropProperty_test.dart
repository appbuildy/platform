...
void main() {
  test('toJson() maps JSON', () {
    final SchemaMyThemePropProperty myThemeProp = SchemaMyThemePropProperty(
        'Name', MyThemeProp(name: 'name', color: Color(0xFF000000)));
    ...
    expect(jsonMyThemeProp['value']['color'],
        equals(myThemeProp.value.color.value));
  });
  ...
  test('fromJson() deserialization', () {
    ...
    final SchemaMyThemePropProperty myThemeProp =
        SchemaMyThemePropProperty.fromJson(jsonTarget);
